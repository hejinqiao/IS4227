...
public class AccountMgt {
    ...
    public JSONObject editAccountInfo(@WebParam(name = "email") String email, @WebParam(name = "name") String name, @WebParam(name = "address") String address, @WebParam(name = "contactNumber") String contactNumber) {

        ArrayList<String> al = ejbRef.editAccountInfo(email,name,address,contactNumber);
