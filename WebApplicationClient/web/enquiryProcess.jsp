...
<body>
	...
	<div class="wrap">
		...
		<ul class="megamenu skyblue">
						...
						<div class="col2">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="products.html">Rose</a></li>
									<li><a href="products.html">White</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col2">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="products.html">Medium</a></li>
									<li><a href="products.html">Light</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col2">
							<div class="h_nav">
								<h4>Flavor</h4>
								<ul>
									<li><a href="products.html">Vanilla</a></li>
									<li><a href="products.html">Butter</a></li>
									<li><a href="products.html">Green apple</a></li>
									<li><a href="products.html">Red apple</a></li>
								</ul>	
							</div>												
						</div>
				...
				<li><a class="color5" href="#">Pairings</a>
					<div class="megapanel">
					<div class="row">
						<div class="col2">
							<div class="h_nav">
								<h4>Western</h4>
								<ul>
									<li><a href="sarees.html">Burgers</a></li>
									<li><a href="sarees.html">Pasta</a></li>
									<li><a href="sarees.html">Grilled fish</a></li>
						...
						<div class="col2">
							<div class="h_nav">
								<h4>Asian</h4>
								<ul>
									<li><a href="sarees.html">Naan</a></li>
									<li><a href="sarees.html">Chinese food</a></li>
									<li><a href="sarees.html">Japanese salad</a></li>
						...
						<div class="col2">
							<div class="h_nav">
								<h4>Snacks</h4>
								<ul>
									<li><a href="sarees.html">Fries</a></li>
									<li><a href="sarees.html">Peanuts</a></li>
									<li><a href="sarees.html">Bread</a></li>
				...
				<li><a class="color1" href="#">Bundles</a>
					<div class="megapanel">
					<div class="row">
						<div class="col2">
							<div class="h_nav">
								...
								<ul>
									<li><a href="products.html">bundle1</a></li>
									<li><a href="products.html">bundle2</a></li>
									<li><a href="products.html">bundle3</a></li>
								</ul>	
							</div>							
						</div>
						<div class="col2">
							<div class="h_nav">
								...
								<ul>
									<li><a href="products.html">Business1</a></li>
									<li><a href="products.html">Business2</a></li>
									<li><a href="products.html">Business3</a></li>
						...
						<div class="col2">
							<div class="h_nav">
								<h4>Party    bundle</h4>
								<ul>
									<li><a href="products.html">Party bundle1</a></li>
									<li><a href="products.html">Party bundle2</a></li>
									<li><a href="products.html">Party bundle3</a></li>
					...
					<div class="row">
						<div class="col2">
							<div class="h_nav">
								<h4>Account</h4>
								<ul>
									<li><a href="products.html">Register</a></li>
						...
						<div class="col2">
							<div class="h_nav">
								<h4>About us</h4>
								<ul>
									<li><a href="products.html">Company info</a></li>
	...
	<div class="new-product">
				...
				<div class="coats">
			        <h3 class="c-head">All Enquiries</h3>
		        </div>
					<div class="clearfix"></div>
				</div>
				<div class="singel_right">
                                    <form action="replyEnquiry.jsp" method="POST" >
	...
	java.util.List<wss.EnquiryEntity> result = port.viewAllEnquiry(adminId);
        java.lang.Long enquiryId;
        java.lang.String content;
        java.lang.Boolean status;
        java.lang.String date;
        java.lang.Long accountId;
	for (Object o: result){
        enquiryId = ((wss.EnquiryEntity) o).getId();
        content = ((wss.EnquiryEntity) o).getContent();
        status = ((wss.EnquiryEntity) o).isReplied();
        date = ((wss.EnquiryEntity) o).getDate().toString().substring(0, 10);
        accountId = ((wss.EnquiryEntity) o).getAccountId();
    %>
    <tr> 
        <td><input type="radio" name="enquiryId" value=<%=enquiryId%>></td>
        <td><%=enquiryId%></td>
        <td><%=content%></td>
        <td><%=accountId%></td>
        <td><%=date%></td>
