...
public interface AccountMgtWS {
    ...
    @RequestWrapper(localName = "register", targetNamespace = "http://WSS/", className = "wss.Register")
    @ResponseWrapper(localName = "registerResponse", targetNamespace = "http://WSS/", className = "wss.RegisterResponse")
    @Action(input = "http://WSS/AccountMgtWS/registerRequest", output = "http://WSS/AccountMgtWS/registerResponse")
