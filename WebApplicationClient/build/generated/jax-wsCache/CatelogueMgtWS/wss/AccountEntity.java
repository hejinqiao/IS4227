 ...
 *         &lt;element name="enquiryList" type="{http://WSS/}enquiryEntity" maxOccurs="unbounded" minOccurs="0"/>
...
public class AccountEntity {
    ...
    @XmlElement(nillable = true)
    protected List<EnquiryEntity> enquiryList;
    ...
    /**
     * Gets the value of the enquiryList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the enquiryList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEnquiryList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<EnquiryEntity> getEnquiryList() {
        if (enquiryList == null) {
            enquiryList = new ArrayList<EnquiryEntity>();
        }
